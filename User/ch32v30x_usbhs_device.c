...
/******************************************************************************/
/* USB设备描述符 */
UINT8 MyDevDescr[18] = { 0x12, 0x01, 0x00, 0x02, 0xFF, 0x00, 0x00, 0x40, 0x00,
        0xF0, 0x05, 0xF0, 0x00, 0x01, 0x01, 0x02, 0x03, 0x01 };
...
/* USB产商字符串描述符 */
const UINT8 MyManuInfo[] = { 8, 0x03, 'N', 0x00, 'I', 0x00, 'E', 0x00 };

/* USB产品字符串描述符 */
const UINT8 MyProdInfo[] = { 36, 0x03, 'H', 0x00, 'S', 0x00, '-', 0x00, 'L',
        0x00, 'I', 0x00, 'N', 0x00, 'K', 0x00, ' ', 0x00, 'C', 0x00, 'M', 0x00,
...
const UINT8 MyBOSDesc[] = { 0x05, 0x0f, 0x16, 0x00, 0x02, 0x07, 0x10, 0x02,
        ...
        0xff, 0x07, };
/* USB全速模式,其他速度配置描述符 */
UINT8 TAB_USB_FS_OSC_DESC[sizeof(MyCfgDescr_HS)] = { 0x09, 0x07, /* 其他部分通过程序复制 */
};
...
void USBHS_RCC_Init(void) {
    RCC->CFGR2 =
    USBHS_PLL_SRC_HSE | USBHS_PLL_SRC_PRE_DIV2 | USBHS_PLL_CKREF_4M; /* PLL REF = HSE/2 = 4MHz */
